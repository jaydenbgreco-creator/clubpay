...
const AddMemberPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.member_id || !formData.first_name) {
      toast.error('Member ID and First Name are required');
      return;
    }
          ...
          <div className="max-w-2xl">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button type="submit" disabled={loading} className="btn-primary flex-1 flex items-center justify-center gap-2" data-testid="save-member-btn">
                  {loading ? (
